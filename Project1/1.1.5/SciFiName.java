...
public class SciFiName   
{
    ...
    public static void main()
    {
        ...
        randDouble = Math.round(getRandomIntegerBetweenRange(0, relativeName1.length()));
        rand = (int) randDouble;
        origin1 = relativeName1.substring(rand - 1, relativeName1.length());
        
        randDouble = Math.round(getRandomIntegerBetweenRange(0, relativeName2.length()));
        rand = (int) randDouble;
        origin2 = relativeName2.substring(rand, relativeName2.length());
        
        System.out.println("Hello " + firstName.substring(0,3) + lastName.substring(0,2) + " " + city.substring(0,2) + school.substring(0,3) + " from " + origin1 + origin2 + ". Welcome!");
